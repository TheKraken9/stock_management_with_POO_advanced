...
@WebServlet(name = "NewMouvementServlet", value = "/NewMouvementServlet")
public class NewMouvementServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/NewMouvement.jsp").forward(request, response);
    }
